...
RSpec.describe CreateEditAuditsController, type: :controller do
  ...
  # Debugging - Check if the users are created successfully before the test starts
  before do
  ...
  describe "POST #create" do
    ...
    it "creates audit and associated records successfully" do
      # Ensure the objects are created before the action is performed
      expect(Company.count).to eq(1)
      expect(User.count).to eq(4)  # We are creating 4 users
